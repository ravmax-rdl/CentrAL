import { Card, CardContent } from '@/components/ui/feature-card';
...
export function FeaturesGrid() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Animate SVG paths and elements
      svgRefs.current.forEach((svg, index) => {
        if (!svg) return;

        // Find all paths and animate them
        ...
        // Animate circles with scale and fade
        circles.forEach((circle, circleIndex) => {
          gsap.fromTo(
            ...
            },
            {
              ...
              opacity: 1,
              duration: 0.8,
              delay: index * 0.3 + circleIndex * 0.1,
              ease: 'back.out(1.7)',
              scrollTrigger: {
                trigger: svg.closest('.card-container'),
                start: 'top 75%',
        ...
        lines.forEach((line, lineIndex) => {
          gsap.fromTo(
            ...
            },
            {
              scaleX: 1,
              duration: 1,
              delay: index * 0.2 + lineIndex * 0.15,
              ease: 'power2.out',
              scrollTrigger: {
                trigger: svg.closest('.card-container'),
                start: 'top 75%',
        ...
        // Add subtle floating animation to entire SVG
        gsap.to(svg, {
          y: -10,
          duration: 3,
          repeat: -1,
      ...
      // Animate text content with subtle fade and slide
      const textElements = sectionRef.current?.querySelectorAll('h2, p, span');
      if (textElements) {
        gsap.fromTo(
          textElements,
          {
  ...
  const addToSvgRefs = (el: SVGSVGElement | null, index: number) => {
    if (el) {
  ...
  return (
    <section ref={sectionRef} className="bg-gray-50 py-4 md:py-8 dark:bg-transparent">
      <div className="mx-auto max-w-4xl lg:max-w-7xl px-6">
        <div className="relative">
          <div ref={cardsRef} className="relative z-10 grid grid-cols-6 gap-3">
            <Card className="card-container relative col-span-full flex overflow-hidden lg:col-span-2">
              {/* ...existing code... */}
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  <svg
                    ref={(el) => addToSvgRefs(el, 0)}
                ...
                <h2 className="mt-6 text-center text-3xl text-green-300 font-semibold">Free</h2>
              </CardContent>
            </Card>
            <Card className="card-container relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                  <svg
                    ref={(el) => addToSvgRefs(el, 1)}
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-foreground">
                    Students can save their progress, track performance over time, and personalize
            ...
            <Card className="card-container relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  <h2 className="text-lg font-medium transition">Interactive Learning</h2>
                  <p className="text-foreground">
                    Interactive quizzes that reinforce learning through instant feedback, helping
                    students assess their understanding.
                  </p>
                </div>
              </CardContent>
            </Card>
            <Card className="card-container relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-foreground">
                      Curated learning materials like high-quality notes and past papers, making it
                      easy for students to study effectively and stay exam-ready.
                    </p>
                  </div>
                </div>
            ...
            <Card className="card-container relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium transition">Collaborative Forum</h2>
                    <p className="text-foreground">
                      Public forum where students can ask questions, share insights, and collaborate
